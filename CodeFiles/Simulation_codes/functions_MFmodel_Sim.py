...
def default_pars():
    ...
    ### Network Parameters ###
    # z['JE'] = 0.97*0.2609 # self-coupling strength [nA]
    # z['JI'] = -0.0497 # cross-coupling strength [nA]
    # z['I0'] = 0.3255 # background current [nA]
    z['JE'] =  (1. - 4.*0.0724) *0.2609 # self-coupling strength [nA]
    z['JI'] = -(1. + 4.*0.2209) *0.0497 # cross-coupling strength [nA]
    z['I0'] =  (1. - 4.*0.00876)* 0.3255 # background current [nA]
    # z['I0'] =  (1. - 2.*0.01317) * 0.3255 # background current [nA]
...
def run_sim(pars,expt_pars,expt, verbose=False):
    ...
    r1smooth_traj = []
    r2smooth_traj = []
    # win_120_list = []                                                                                                 # If I record and report data from each trial

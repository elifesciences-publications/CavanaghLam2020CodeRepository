function [dx_list,P_corr_Subj_list,ErrBar_P_corr_Subj_list,Psychometric_fit_params] = FinalPsychometricsInFunc_Final(EvidenceUnitsACollapsed,EvidenceUnitsBCollapsed,ChosenTargetCollapsed,...
    TrialErrorComp,Method)
